        ...
        <div className={classes.vglInnerColumn}>
          <div>
            <div className={classes.vglContentElement}>
              <div>
                <h2 className={classes.vglContentSecondaryHeading}>
                  Very good light
                </h2>
                <h3
                  className={classes.vglContentHeading}
                  style={{ fontWeight: "normal", lineHeight: 1.15 }}
                >
                  Light Up Your Inbox
                </h3>
                <p style={{ lineHeight: "1.75em", textAlign: "center" }}>
